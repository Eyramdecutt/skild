    ...
    <div id="home">
        <section className='hero'>
            <div className='copy'>
                ...
                <p>
                    ...
                    Discover,  publish, and operate reusable agent capabilities
                    from a route-driven workspace
                </p>
            </div>
        ...
        <section className='latest'>
            <div className='space-y-2'>
                ...
                className='text-gradient'>Skills</span>
                </h2>
                <p>
                    {" "}
                    Latest skills loaded from database in descending creation
                    order.
                </p>
            </div>
